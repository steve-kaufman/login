...
nnoremap B ^
nnoremap E $
nnoremap O :call ShiftO(v:count)
...
let s:l = 154 - ((27 * winheight(0) + 25) / 50)
...
unlet! s:wipebuf
set winheight=999 winwidth=88 shortmess=filnxtToOc
